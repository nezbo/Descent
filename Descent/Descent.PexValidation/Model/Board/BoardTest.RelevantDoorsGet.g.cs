// <copyright file="BoardTest.RelevantDoorsGet.g.cs">Copyright ©  2011</copyright>
// <auto-generated>
...
public void RelevantDoorsGet564()
{
    global::Descent.Model.Board.Board board;
    Door[] doors;
    board = new global::Descent.Model.Board.Board(2, 2, (Texture2D)null);
    doors = this.RelevantDoorsGet(board);
    Assert.IsNotNull((object)doors);
    Assert.AreEqual<int>(0, doors.Length);
