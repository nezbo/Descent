...
namespace Descent.GUI.SubElements
{
    class HeroElement : GUIElement
    {
        ...
        public override void Draw(SpriteBatch draw)
        {
            ...
            draw.DrawString(GUI.Font, hero.Health + "/" + hero.MaxHealth, new Vector2(healthRect.X, healthRect.Y), Color.Black);
            draw.DrawString(GUI.Font, hero.Fatigue + "/" + hero.MaxFatigue, new Vector2(fatigueRect.X, fatigueRect.Y), Color.Black);
            draw.DrawString(GUI.Font, hero.SpeedLeft + "/" + hero.Speed, new Vector2(movementRect.X, movementRect.Y), Color.Black);
        }
    }
}
