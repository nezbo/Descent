// <copyright file="DoorTest.Constructor.g.cs">Copyright ©  2011</copyright>
// <auto-generated>
...
{
    Door door;
    door = this.Constructor
               (0, default(Point), default(Point), 1, default(Point), default(Point), 
    ...
    Assert.AreEqual<int>(1, door.Areas[1]);
    Assert.IsNull(door.Texture);
}
[TestMethod]
[PexGeneratedBy(typeof(DoorTest))]
public void Constructor957()
{
    Door door;
    door = this.Constructor
...
public void ConstructorThrowsContractException886()
{
    try
    {
      Door door;
      door = this.Constructor
                 (0, default(Point), default(Point), 0, default(Point), default(Point), 
                                                        Orientation.H, RuneKey.Red, (Texture2D)null);
      throw 
